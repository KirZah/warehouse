...
#     UNLOCK TABLES;
    ...
    archive_from_tmp_tables: begin
        ...
        SET @`sql` := CONCAT('
            SELECT * INTO OUTFILE \'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/warehouse/archive/', archive_number, '_suppliers.csv\'
        ...
        SET @`sql` := CONCAT('
            SELECT * INTO OUTFILE \'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/warehouse/archive/', archive_number, '_supplies.csv\'
                FIELDS TERMINATED BY \',\' OPTIONALLY ENCLOSED BY \'"\'
                LINES TERMINATED BY ''\\r\\n''
                FROM tmp_supplies;'
            );
        ...
        SET @`sql` := CONCAT('
            SELECT * INTO OUTFILE \'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/warehouse/archive/', archive_number, '_goods_supplies.csv\'
                FIELDS TERMINATED BY \',\' OPTIONALLY ENCLOSED BY \'"\'
                LINES TERMINATED BY ''\\r\\n''
                FROM tmp_goods_supplies;'
            );
        PREPARE `stmt` FROM @`sql`;
        EXECUTE `stmt`;
        DEALLOCATE PREPARE `stmt`;
        ...
        SET @`sql` := CONCAT('
            SELECT * INTO OUTFILE \'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/warehouse/archive/', archive_number, '_catalog.csv\'
                FIELDS TERMINATED BY \',\' OPTIONALLY ENCLOSED BY \'"\'
                LINES TERMINATED BY ''\\r\\n''
                FROM tmp_catalog;'
            );
        ...
        SET @`sql` := CONCAT('
            SELECT * INTO OUTFILE \'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/warehouse/archive/', archive_number, '_goods.csv\'
                FIELDS TERMINATED BY \',\' OPTIONALLY ENCLOSED BY \'"\'
                LINES TERMINATED BY ''\\r\\n''
                FROM tmp_goods;'
            );
        ...
        SET @`sql` := CONCAT('
            SELECT * INTO OUTFILE \'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/warehouse/archive/', archive_number, '_storage.csv\'
                FIELDS TERMINATED BY \',\' OPTIONALLY ENCLOSED BY \'"\'
                LINES TERMINATED BY ''\\r\\n''
                FROM tmp_storage;'
            );
        ...
        SET @`sql` := CONCAT('
            SELECT * INTO OUTFILE \'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/warehouse/archive/', archive_number, '_customers.csv\'
                FIELDS TERMINATED BY \',\' OPTIONALLY ENCLOSED BY \'"\'
                LINES TERMINATED BY ''\\r\\n''
                FROM tmp_customers;'
            );
        ...
        SET @`sql` := CONCAT('
            SELECT * INTO OUTFILE \'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/warehouse/archive/', archive_number, '_shipments.csv\'
                FIELDS TERMINATED BY \',\' OPTIONALLY ENCLOSED BY \'"\'
                LINES TERMINATED BY ''\\r\\n''
                FROM tmp_shipments;'
            );
        ...
        SET @`sql` := CONCAT('
            SELECT * INTO OUTFILE \'C:/ProgramData/MySQL/MySQL Server 8.0/Uploads/warehouse/archive/', archive_number, '_goods_shipments.csv\'
                FIELDS TERMINATED BY \',\' OPTIONALLY ENCLOSED BY \'"\'
                LINES TERMINATED BY ''\\r\\n''
                FROM tmp_goods_shipments;'
            );
        PREPARE `stmt` FROM @`sql`;
        EXECUTE `stmt`;
        DEALLOCATE PREPARE `stmt`;
...
DROP PROCEDURE IF EXISTS create_temporary_tables//
CREATE
...
creating_temporary_tables: begin
        ...
        create TEMPORARY table IF NOT EXISTS warehouse.tmp_suppliers
        (
        ...
        create TEMPORARY table IF NOT EXISTS warehouse.tmp_supplies
        (
            id              int auto_increment unique,
        ...
        create TEMPORARY table IF NOT EXISTS warehouse.tmp_goods_supplies
        (
        ...
        create TEMPORARY table IF NOT EXISTS warehouse.tmp_catalog
        (
            id              int auto_increment unique,
        ...
        create TEMPORARY table IF NOT EXISTS warehouse.tmp_goods
        (
            id              int auto_increment unique,
        ...
        create TEMPORARY table IF NOT EXISTS warehouse.tmp_storage
        (
            goods_id    int         not null unique,
        ...
        create TEMPORARY table IF NOT EXISTS warehouse.tmp_customers
        (
            id      int auto_increment unique,
        ...
        create TEMPORARY table IF NOT EXISTS warehouse.tmp_goods_shipments
        (
            goods_id     int not null unique,
        ...
        create TEMPORARY table IF NOT EXISTS warehouse.tmp_shipments
        (
            id              int auto_increment unique,
